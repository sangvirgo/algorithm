...
/*
 BorderLayout là một trong các bộ quản lý bố cục (layout managers) của Java Swing, 
 được sử dụng để sắp xếp các thành phần trong một container (như JFrame hoặc JPanel). Bộ quản lý bố cục này chia container thành năm vùng chính, mỗi vùng có thể chứa một thành phần:

NORTH: Vùng phía trên cùng.
SOUTH: Vùng phía dưới cùng.
EAST: Vùng bên phải.
WEST: Vùng bên trái.
CENTER: Vùng trung tâm, chiếm phần còn lại của container sau khi các vùng khác đã được chiếm dụng.
Cách hoạt động của BorderLayout
NORTH, SOUTH, EAST, và WEST có thể chứa một thành phần, và mỗi thành phần trong những vùng này sẽ được mở rộng để chiếm toàn bộ không gian của vùng tương ứng.
CENTER sẽ chiếm phần không gian còn lại không được chiếm bởi các vùng còn lại. Thành phần trong vùng CENTER sẽ được mở rộng để chiếm toàn bộ không gian còn lại của container.
 */
